"""
Django settings for screencastcms project.
...
SECRET_KEY = 'django-insecure-im+^#=($%hp*n=(=_ug1*9gtw!gnjt12+$)#ag5r_x17%(*@#k'
...
ROOT_URLCONF = 'screencastcms.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "screencastcms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'screencastcms.wsgi.application'
...
# CORS settings for Node.js frontend
